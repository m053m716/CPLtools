function rates = CPL_plotSpikeRate(SPK,varargin)
%% CPL_PLOTSPIKERATE Look at time-varying instantaneous firing rate estimate
%
%   rates = CPL_PLOTSPIKERATE(SPK)
%
%   --------
%    INPUTS
%   --------
%      SPK      :       Table of spiking activity generated by
%                       SIMPLE_SPIKE_ANALYSIS or CPL_LOADSPIKETRAINS.
%
...
% WLEN = 0.050;       % smooth window length for "fast" (trial-related)
FS_DEC = 1;         % Decimated sample rate for rate estimation
% FS_DEC = 200;       % decimated rate for "fast" (trial-related)
...
for iN = 1:N
   ...
   try
      ...
      disp(me.message);
      error('Check FS_DEC; may be too slow for small WLEN value.');
   end
   waitbar(iN/N);
end
delete(h);
