function [y,t,optw,gs,C,confb95,yb] = ssvkernel(x,tin,varargin)
%% SSVKERNEL   Returns an optimized kernel density estimate
%              Uses a Gauss kernel function with locally adapted bandwidths
% 
...
%
% Updated by: Max Murphy - July 2017
...
VERBOSE = false;    % Display status to command line
...
% Balloon estimator (speed optimized)
idx = find(y_hist ~= 0);
