function [class,clu,tree,temp] = DoSPC(features,varargin)
...
pars.SWCYC = 100;                   % Swendsen-Wang cycles
...
pars.NMINCLUS = 7;                  % Absolute minimum cluster size diff
pars.RMINCLUS = 0.005;              % Relative minimum cluster size diff
pars.MAX_SPK = 2000;                % Max. # of features for SPC
pars.TEMPSD = 2;                    % # of SD for template matching
pars.NCLUS_MAX = 16;                % Max. # of clusters
